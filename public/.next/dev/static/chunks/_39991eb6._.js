...
function CartProvider({ children }) {
    ...
    const addItem = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[addItem]": (item, quantity = 1, size, instructions)=>{
            setCart({
                "CartProvider.useCallback[addItem]": (prev)=>{
                    ...
                    const existing = prev.find({
                        "CartProvider.useCallback[addItem].existing": (i)=>i.id === item.id && !i.size && !i.instructions
                    }["CartProvider.useCallback[addItem].existing"]);
                    if (existing) {
                        return prev.map({
                            "CartProvider.useCallback[addItem]": (i)=>i.id === item.id && !i.size && !i.instructions ? {
                                    ...i,
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                window.dispatchEvent(new CustomEvent("cheezious:toast", {
                    detail: {
    ...
    const updateQuantity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[updateQuantity]": (id, delta)=>{
            setCart({
                "CartProvider.useCallback[updateQuantity]": (prev)=>{
                    const next = prev.map({
                        "CartProvider.useCallback[updateQuantity].next": (i)=>i.id === id ? {
                                ...i,
                                quantity: i.quantity + delta
                            } : i
                    }["CartProvider.useCallback[updateQuantity].next"]).filter({
                        "CartProvider.useCallback[updateQuantity].next": (i)=>i.quantity > 0
                    }["CartProvider.useCallback[updateQuantity].next"]);
                    return next;
                }
    ...
    const openSidebar = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[openSidebar]": ()=>setIsSidebarOpen(true)
    }["CartProvider.useCallback[openSidebar]"], []);
    const closeSidebar = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[closeSidebar]": ()=>setIsSidebarOpen(false)
    }["CartProvider.useCallback[closeSidebar]"], []);
    const toggleSidebar = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[toggleSidebar]": ()=>setIsSidebarOpen({
                "CartProvider.useCallback[toggleSidebar]": (o)=>!o
            }["CartProvider.useCallback[toggleSidebar]"])
    }["CartProvider.useCallback[toggleSidebar]"], []);
    const itemCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CartProvider.useMemo[itemCount]": ()=>cart.reduce({
    ...
    const totalPrice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CartProvider.useMemo[totalPrice]": ()=>cart.reduce({
                "CartProvider.useMemo[totalPrice]": (sum, i)=>sum + i.priceNumber * i.quantity
...
_s(CartProvider, "heELzNC+xSAsZpuHJKMGhMgKOIg=");
_c = CartProvider;
function useCart() {
    _s1();
                        ...
                        "ToastHost.useEffect.handler": ()=>{
                            setToasts({
                                "ToastHost.useEffect.handler": (prev)=>prev.filter({
                                        "ToastHost.useEffect.handler": (t)=>t.id !== id
                                    }["ToastHost.useEffect.handler"])
                            }["ToastHost.useEffect.handler"]);
                        }
                    }["ToastHost.useEffect.handler"], 2200);
                }
            }["ToastHost.useEffect.handler"];
...
//# sourceMappingURL=_39991eb6._.js.map